...
#   ---- game modes ----
    ...
    if menu_selection == 200:       # -- ABOUT --
        ...
        created = font.render(
            "-- Created by Rodrigo Formigon, Heavy Games --", True, (white))
        version = font.render("-- Version 0.1.0 --", True, (white))

        font = pygame.font.SysFont("Retro Computer", 20, False, False)
        back = font.render("> back <", True, (white))

        screen.blit(created, (160, (SCREEN_HEIGHT/2)+30))
        screen.blit(version, ((SCREEN_WIDTH/2)-80, (SCREEN_HEIGHT/2)+60))
